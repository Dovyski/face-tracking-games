...
var MenuState = function() {
	...
	this.create = function() {
		this.mPlayBtn 		= Game.add.button(Game.world.centerX - 90, Game.world.centerY - 25, 'blue-button', this.onPlay, this, 1, 0, 2);
		this.mCreditsBtn 	= Game.add.button(Game.world.centerX - 90, this.mPlayBtn.position.y + this.mPlayBtn.height + 20, 'blue-button', this.onCredits, this, 1, 0, 2);
